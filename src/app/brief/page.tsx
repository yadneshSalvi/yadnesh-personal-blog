    ...
    <main className="mx-auto max-w-3xl px-6 py-16 sm:py-20">
      ...
      <section className="mt-16">
        ...
        <ul className="mt-4 space-y-2 text-sm text-muted">
          <li>
            <a href="/brief/feed.xml" className="transition-colors hover:text-accent">
              /brief/feed.xml
            </a>{" "}
          ...
          <li>
            <a
              href="/brief/daily/feed.xml"
              className="transition-colors hover:text-accent"
            >
              /brief/daily/feed.xml
            </a>{" "}
            dailies only
          </li>
          <li>
            <a
              href="/brief/weekly/feed.xml"
              className="transition-colors hover:text-accent"
            >
              /brief/weekly/feed.xml
            </a>{" "}
            weeklies only
          </li>
          <li>
