// src/app/newsletter/api/issues.json/route.ts
  ...
  return Response.json(
    {
      ...
      site: absoluteUrl("/newsletter"),
      schema_version: BRIEF_SCHEMA_VERSION,
      feeds: {
        all: absoluteUrl("/newsletter/feed.xml"),
        daily: absoluteUrl("/newsletter/daily/feed.xml"),
        weekly: absoluteUrl("/newsletter/weekly/feed.xml"),
      },
      count: issues.length,
      issues,
    },
