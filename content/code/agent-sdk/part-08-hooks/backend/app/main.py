"""Part 8: hooks. Approvals gate what you ask about; hooks see everything.
A PreToolUse tripwire blocks rm before any human is asked, every tool call
lands in an audit log, and desk facts ride into each prompt."""
