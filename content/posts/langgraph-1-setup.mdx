...
It watches your files and restarts the server every time you save. You'll change `main.py` constantly across this series; `--reload` means you never have to manually stop and restart. It's a development-only flag; it comes off in Part 8 when we deploy.
</Callout>
...
<Figure
  ...
  caption="The Next.js welcome page. In Part 4, everything you see here gets deleted and replaced with your chat UI."
  width={1120}
  height={640}
/>
...
<Quiz
  questions={[
    ...
    },
    {
      ...
      answer: 1,
      explain: "It watches your files and restarts the server on save, so you never stop and start it by hand while developing. It comes off in Part 8 when you deploy.",
    },
    {
    ...
    },
    {
      ...
      answer: 3,
      explain: "Each port hosts exactly one process. They are two independent servers on your machine, strangers for now. Wiring them together is Part 4.",
    },
    {
