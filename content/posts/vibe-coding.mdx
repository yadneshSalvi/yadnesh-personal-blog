...
description: "A field report on vibe-coding with AI assistants in 2025: where letting the model drive actually works, where it falls apart, and how to tell the difference."
image: "/vibecoding.jpg"
imageAlt: "Cartoon of a smiling bearded man in headphones at a laptop, pointing up with one hand and making a peace sign with the other, under the headline 'Vibe-coding'."
...
I would like to end, the blog with Andrew Ng's answer on job opportunities for coders in an AI world.
