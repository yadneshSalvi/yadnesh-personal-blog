...
<Figure src="/images/posts/what-is-middleware-explained/fig-3.png" alt="A request travels down through a session layer and an auth layer, then turns around at auth with a 403 response and goes back out; the messages layer and view below are faded because they never ran." caption="Slamming the door: a layer that returns without handing off means nothing inside it ever runs." width={1536} height={1024} />
